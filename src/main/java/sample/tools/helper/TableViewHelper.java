...
public class TableViewHelper<T> {
    ...
    public TableViewHelper<T> addStrColumn(String text, Function<T, String> toString) {
        return addStrColumn(text,toString,Pos.CENTER);
    }

    public TableViewHelper<T> addStrColumn(String text, Function<T, String> toString,Pos pos) {
        this.tableView.getColumns().add(TableViewHelper.createStrColumn(text, toString,pos));
        return this;
    }

    public TableViewHelper<T> addStrPropertyColumn(String text, Function<T, ObservableValue<String>> ob) {
        return addStrPropertyColumn(text,ob,Pos.CENTER);
    }
    public TableViewHelper<T> addStrPropertyColumn(String text, Function<T, ObservableValue<String>> ob,Pos pos) {
        this.tableView.getColumns().add(TableViewHelper.createStrPropColumn(text, ob,pos));
        return this;
    }
    ...
    public static <T> TableColumn<T, String> createStrColumn(String text, Function<T, String> toString, Pos pos) {
        TableColumn<T, String> tableColumn = new TableColumn<>(text);
        tableColumn.setCellFactory(tStringTableColumn -> {
            TableCell<T, String> tc = new TableCell<>(){
                @Override
    ...
    public static <T> TableColumn<T, String> createStrPropColumn(
        String text, Function<T, ObservableValue<String>> toStringProperty, Pos pos) {
