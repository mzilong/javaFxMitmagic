 ...
 * of {@code EnteredExitedHandler} followed by {@code EventHandlerManager}.
 * For details, please refer to {@link FxEventBus} event dispatch.
 * @author mzl
 */
public class BaseEventDispatcher extends CompositeEventDispatcher {
    private final EnteredExitedHandler enteredExitedHandler;

    private final EventHandlerManager eventHandlerManager;

    public BaseEventDispatcher(final Object eventSource) {
